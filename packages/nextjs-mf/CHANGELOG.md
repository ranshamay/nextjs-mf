...
## [6.5.10](https://github.com/module-federation/nextjs-mf/compare/nextjs-mf-6.5.9...nextjs-mf-6.5.10) (2023-07-05)

### Dependency Updates

* `utils` updated to version `1.8.10`
* `node` updated to version `0.15.9`
* `utils` updated to version `1.8.10`
* `utils` updated to version `1.8.10`
* `node` updated to version `0.15.9`
