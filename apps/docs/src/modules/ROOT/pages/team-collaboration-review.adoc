...
====
{
  ...
  "plugins": ["@ranshamay/eslint-plugin"]
}
====
...
module.exports = {
  ...
  // Use @ranshamay/jest-federated-module-loader to mock remote modules
  moduleNameMapper: {
    "@ranshamay/jest-federated-module-loader": "@ranshamay/jest-federated-module-loader",
  },
};
```
